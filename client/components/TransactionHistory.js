...
import ethLogo from "../assets/images/ethCurrency.png";
import { FiArrowUpRight } from "react-icons/fi";

const style = {
  wrapper: `text-white select-none flex-1 flex items-end justify-end my-3 mx-3`,
...
const TransactionHistory = () => {
  const { isLoading, currentAccount } = useContext(TransactionsContext);
